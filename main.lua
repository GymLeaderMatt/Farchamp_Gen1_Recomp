-- Adds Farchamp, a Fighting/Normal fusion of Farfetch'd and Machamp, as a
-- new Pokemon you can find and use like any other Gen 1 mon.
return function(mod)

  mod.content.pokemon:register("FARCHAMP", {
    ...
    evolutions = {},
    spriteFront = mod.path .. "/assets/sprites/farchamp.png",
    spriteBack = mod.path .. "/assets/sprites/farchamp.png",
    frontSize = 7,
    trueColor = true,
    palette = "BROWNMON",
    dexEntry = {
  ...
  mod.content.icons:register("FARCHAMP", "MON")
  mod.content.cries:register("FARCHAMP", { base = "PIDGEY" })
end
